...
description: >
  ...
  Sincroniza contexto desde archivos de memoria actualizados por /update-memory.
  Usar al cambiar de IDE o maquina para que el agente conozca lo que otro entorno hizo.
origin: local
category: context
local_only: true
when_to_use:
  - Cambiar de IDE o máquina
  - Sincronizar contexto entre entornos
  - Verificar qué hizo el otro agente
triggers:
  - /update-context
