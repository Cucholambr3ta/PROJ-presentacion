...
description: >
  SKILL LOCAL — NO AGREGAR a releases de evol-dd.
  ...
  paquete instalador. Multi-proyecto: funciona en cualquier repo.
origin: local
category: release
local_only: true
when_to_use:
...
> **SKILL LOCAL — NO AGREGAR a releases de evol-dd**
> Esta skill es personal del usuario. No incluir en el paquete pip ni en el repo de evol-dd.
> Se ejecuta desde `~/.agents/skills/` y funciona en cualquier proyecto.
...
- **Esta skill NO se incluye en releases de evol-dd**
- **Es local del usuario y funciona en múltiples proyectos**
