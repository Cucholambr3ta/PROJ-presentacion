        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14">
          ...
          <div className="md:sticky md:top-[10vh] md:h-[80vh] flex flex-col justify-center py-12">
            ...
            <h1 style={{
              ...
              Gestión & <br />
              <span style={{ fontStyle: "italic", color: "#10B981" }}>Metodología Ágil</span>
            </h1>
          ...
          <ContainerScroll className="min-h-[500vh] py-24 space-y-[20vh]">
              ...
              <div style={{
                ...
                <div style={{ borderLeft: "3px solid #10B981", background: "rgba(16,185,129,0.03)", padding: "1.25rem 1.5rem", borderRadius: "0 1rem 1rem 0" }}>
                  <p style={{ color: "#fafaf9", fontSize: "0.95rem", fontStyle: "italic", margin: 0, lineHeight: 1.5 }}>
                    "Cada rol elimina dependencias: mientras Héctor consolida la capa de datos, Alejandro construye las interfaces y José garantiza la coherencia arquitectónica."
                  </p>
                </div>
              </div>
            </CardSticky>
            ...
            <CardSticky index={3} incrementY={60} incrementZ={0} className="w-full" style={{ top: `calc(10vh + 90px)` }}>
              <div style={{
                ...
                <p style={{ fontSize: "1.1rem", color: "#94a3b8", lineHeight: 1.7, maxWidth: "100%" }}>
              ...
              <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
                  <div style={{ background: "rgba(15, 23, 42, 0.35)", border: "1px solid rgba(255, 255, 255, 0.05)", borderRadius: "1rem", padding: "1.5rem" }}>
                    ...
                    <h3 style={{ color: "#fafaf9", fontSize: "1.1rem", fontWeight: 800, margin: "0 0 0.5rem 0" }}>Supabase</h3>
                  ...
                  <div style={{ background: "rgba(15, 23, 42, 0.35)", border: "1px solid rgba(255, 255, 255, 0.05)", borderRadius: "1rem", padding: "1.5rem" }}>
                    ...
                    <h3 style={{ color: "#fafaf9", fontSize: "1.1rem", fontWeight: 800, margin: "0 0 0.5rem 0" }}>Turborepo</h3>
                    <p style={{ color: "#94a3b8", fontSize: "0.85rem", margin: 0, lineHeight: 1.5 }}>
                  ...
                  <div style={{ background: "rgba(15, 23, 42, 0.35)", border: "1px solid rgba(255, 255, 255, 0.05)", borderRadius: "1rem", padding: "1.5rem" }}>
                    ...
                    <h3 style={{ color: "#fafaf9", fontSize: "1.1rem", fontWeight: 800, margin: "0 0 0.5rem 0" }}>Postgres RLS</h3>
                    <p style={{ color: "#94a3b8", fontSize: "0.85rem", margin: 0, lineHeight: 1.5 }}>
